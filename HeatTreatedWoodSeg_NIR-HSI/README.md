...
これができれば、色に左右されない特徴を学習するための土台ができ、MAEで得られる潜在表現が化学的特徴をきちんと反映したものになるかもしれない。

MAEの学習データが Abs 2nd deriv になるなら潜在空間のL2正規化いるかな？Ref(SNV)との幾何を整合させるためにしたけどその必要はなくなるかもしれない。
latentn の L2正規化 Optional に修正しようかな。クラスタリングもCosine K-Meansをやめるなら以下が使えそう。
